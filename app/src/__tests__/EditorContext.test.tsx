...
function renderWithProvider(ui: React.ReactElement, initial?: Partial<EditorState>) {
    ...
    <div>
      ...
      <button
        ...
        onClick={() =>
          ctx.setLayers((prev) => [
            ...prev,
            { id: 'new-layer', name: 'New Layer', type: 'text', locked: false, visible: true },
          ])
        }
      >
        Add Layer
...
describe('EditorContext', () => {
  ...
  describe('with initial values', () => {
    ...
    it('accepts initial frameSize', () => {
      renderWithProvider(<TestConsumer />, { frameSize: { width: 500, height: 500 } });
      expect(screen.getByTestId('frameSize').textContent).toBe('500x500');
    });

    it('accepts initial layers', () => {
      const initialLayers = [
        { id: 'l1', name: 'Layer 1', type: 'text' as const, locked: false, visible: true },
      ];
